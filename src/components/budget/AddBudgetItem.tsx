...
export const AddBudgetItem = ({
  ...
  const handleAddItem = () => {
    if (newItem.category && newItem.estimatedCost) {
      onAddItem(newItem.category, newItem.description, parseFloat(newItem.estimatedCost));
  ...
  return <Card className="mb-8">
      ...
      <CardContent>
        ...
        <Button onClick={handleAddItem} className="mt-4 bg-wedding-navy hover:bg-wedding-navy/80 text-rose-500">
