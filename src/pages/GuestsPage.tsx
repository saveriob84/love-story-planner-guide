...
const GuestsPage = () => {
  ...
  const filteredGuests = (rsvpFilter?: Guest["rsvp"]) => {
    return guests.filter(guest => {
      ...
      return rsvpFilter ? matchesSearch && guest.rsvp === rsvpFilter : matchesSearch;
    });
  };
  ...
  return <MainLayout>
      <div className="py-6 px-4 sm:px-6">
        ...
        {/* Overview Cards */}
        <GuestStats totalGuests={stats.totalGuests} confirmedGuests={stats.confirmedGuests} pendingGuests={stats.pendingGuests} declinedGuests={stats.declinedGuests} totalAttending={stats.totalAttending} />
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <Input placeholder="Cerca ospiti..." className="pl-10 w-full max-w-xs" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} />
              </div>
              
              <Dialog open={showPrintDialog} onOpenChange={setShowPrintDialog}>
                <Button variant="outline" onClick={() => setShowPrintDialog(true)} className="flex items-center gap-2">
              ...
              <Button onClick={handleDownloadPDF} variant="default" className="flex items-center gap-2 bg-green-500 hover:bg-green-400">
